...
void loop() {
  ...
  if(packetSize) {
    ...
    LoRa.readBytes(packetBuffer, packetSize);
        ...
        tb.sendTelemetryFloat("Jeep ID", (packetBuffer[2]));    
        Serial.println("Speed:              " + String(speed, 10));
        tb.sendTelemetryFloat("Ground Speed", speed);
